<template>
  <div>
    ...
    <p>
      ...
      >提供了水印的插件，使用非常简单，首先可以在实例化<code>simple-mind</code>时提供水印的选项配置来直接显示水印：
    </p>
    ...
    <p>
      此外也可以动态更新水印，<code>watermarkConfig</code>的所有配置都可以修改，如果不想再显示水印将<code>text</code>传入空字符串即可。
    </p>
