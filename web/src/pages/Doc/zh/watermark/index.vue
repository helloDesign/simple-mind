<template>
  <div>
    ...
    <p>
      配置请参考<code>MindMap</code>类的<a href="/mind-map/#/doc/zh/constructor"
        >实例化选项</a
      >。
    </p>
    <h2>注册</h2>
...
<span class="hljs-comment">// import Watermark from &#x27;simple-mind/src/Watermark.js&#x27; v0.6.0以下版本使用该路径</span>

MindMap.usePlugin(Watermark)
</code></pre>
    <p>
      注册完且实例化<code>MindMap</code>后可通过<code>mindMap.watermark</code>获取到该实例。
    </p>
    <h2>方法</h2>
    <h3>draw()</h3>
    <p>重新绘制水印。</p>
