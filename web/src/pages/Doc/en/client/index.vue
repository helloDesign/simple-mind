<template>
  <div>
    <h1>Client</h1>
    <p>
      This project also provides a client version using
      <a href="https://www.electronjs.org/">Electron</a> Development. Supports
    ...
    <blockquote>
      <p>
        The client version may lag behind the online version. To try new
        features, please prioritize using the online version.
      </p>
    </blockquote>
    <p>
      You can directly download the corresponding client for installation and
      use, and two download addresses are provided:
    </p>
    <p>
      Github：<a href="https://github.com/wanglin2/mind-map/releases"
        >releases</a
      >。
    </p>
    <p>
