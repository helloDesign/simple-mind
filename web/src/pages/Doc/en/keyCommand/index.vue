<template>
  <div>
    ...
    <p>
      The <code>keyCommand</code> instance is responsible for adding and
      triggering shortcuts. It includes some built-in shortcuts and can also be
      added manually. The <code>mindMap.keyCommand</code> instance can be
    ...
    <p>Add a shortcut</p>
    <p>
      <code>key</code>: Shortcut key, key values can be viewed at
      <a
        href="https://github.com/wanglin2/mind-map/blob/main/simple-mind/src/core/command/keyMap.js"
        >keyMap.js</a
      >
      Example:
    </p>
...
mindMap.keyCommand.addShortcut(<span class="hljs-string">&quot;Control+Enter&quot;</span>, <span class="hljs-function">() =&gt;</span> {});
    ...
    <p>
      Remove a shortcut command, if <code>fn</code> is not specified, all
      callback methods for the shortcut will be removed
    </p>
